...
// ============================================================================
//  ColorSystem — the seed color system, shared with the design-system web port
//  (templates/shared/color-system.ts) and the visual-design-modernization
//  skill's references/color-system.md.
//
...
//
//  Cross-platform: HSB / luminance are read via NSColor on macOS and UIColor on
//  iOS / watchOS — same algorithm, so the seed math is real on every target.
// ============================================================================
