...
**Status**: Accepted (partially superseded by ADR-0021; exact-revision, dispatch, shipping, and delivery-role clauses replaced by the current Dev Team delivery contract)
**Date**: 2026-07-24
